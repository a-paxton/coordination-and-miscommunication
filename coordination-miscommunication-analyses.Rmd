...
```{r plot-workspace-drps, eval=FALSE, echo=FALSE,fig.width=4, fig.height=3, fig.align='center'}
...
```{r plot-miscommunication-x-workspace-congruence, eval=FALSE, echo=FALSE,fig.width=3, fig.height=4, fig.align='center'}
...
```{r plot-turns-x-workspace-congruence, eval=FALSE, echo=FALSE,fig.width=3, fig.height=4, fig.align='center'}
...
```{r plot-all-interactions, eval=FALSE, echo = FALSE,fig.width=5, fig.height=5, fig.align='center'}
